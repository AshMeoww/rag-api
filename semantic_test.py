...
def test_ash_query():
    response = requests.post("http://127.0.0.1:8000/query?q=Who is Ash?")
    ...
    # Check for key concepts from ash.txt
    assert "Ash" in answer.lower(), "Missing 'ash' keyword"
    
    print("✅ Ash query test passed")
